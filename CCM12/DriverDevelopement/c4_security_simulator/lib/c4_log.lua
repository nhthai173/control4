...
MAX_TABLE_LEVELS = 10
function c4_log:PrintTable(tValue, sIndent, level)
	level = level + 1
			...
			if (self._outputPrint) then
				for k,v in pairs(tValue) do
					...
					if (type(v) == "table") then
						self:PrintTable(v, sIndent .. "   ", level)
					end
				end
			end
...
function c4_log:Fatal(strLogText)
	self:Print(0, strLogText)
end

function c4_log:Error(strLogText)
	self:Print(1, strLogText)
end

function c4_log:Warn(strLogText)
	self:Print(2, strLogText)
end

function c4_log:Info(strLogText)
	self:Print(3, strLogText)
end

function c4_log:Debug(strLogText)
	self:Print(4, strLogText)
end

function c4_log:Trace(strLogText)
	self:Print(5, strLogText)
end

function c4_log:LogOutput(level, inputText, ...)
	if (LogEnabled()) then
		if (type(inputText) == "string") then
			inputText = string.format(inputText, ...)
		end
	
		self:Print(level, inputText)
	end
end
...
--[[=============================================================================
    ...
    Parameters:
    strLogText(string) - Format control string
    ...
    None
===============================================================================]]
function LogFatal(strLogText, ...)
	local status, err = pcall(tryLog, 0, strLogText, ...)
	if (not status) then
...
--[[=============================================================================
    ...
    None
===============================================================================]]
function LogError(strLogText, ...)
	local status, err = pcall(tryLog, 1, strLogText, ...)
	if (not status) then
...
--[[=============================================================================
    ...
    None
===============================================================================]]
function LogWarn(strLogText, ...)
	local status, err = pcall(tryLog, 2, strLogText, ...)
	if (not status) then
...
--[[=============================================================================
    ...
    None
===============================================================================]]
function LogInfo(strLogText, ...)
	local status, err = pcall(tryLog, 3, strLogText, ...)
	if (not status) then
...
--[[=============================================================================
    ...
    None
===============================================================================]]
function LogDebug(strLogText, ...)
	local status, err = pcall(tryLog, 4, strLogText, ...)
	if (not status) then
...
--[[=============================================================================
    ...
    None
===============================================================================]]
function LogTrace(strLogText, ...)
	local status, err = pcall(tryLog, 5, strLogText, ...)
	if (not status) then
